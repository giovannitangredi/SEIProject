...
wait(1)
type(Pattern("1590860143525.png").targetOffset(30,-5),"1.8")
wait(1)
type(Pattern("1590860152706.png").targetOffset(25,0),"1.4")
wait(1)
type(Pattern("1590860161363.png").targetOffset(32,-4),"1.92")
wait(3)
